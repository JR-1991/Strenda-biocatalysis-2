...
/**
    ...
    * @param volume_per_sample_unit - Common units include mL (milliliters), μl (microliters), g (grams), or other volume units, depending on whether the samples are liquid or solid.
    * @param mixing_during_sampling - Provide information about whether the reaction was mixed during sampling, as this can affect the representativeness of the collected sample.
    * @param vessel_opened_for_sampling - Information about whether the reaction vessel was opened for sampling or not.
    * @param gas_phase - Information about the composition of the gas phase above the reaction solution, including gases such as nitrogen, carbon dioxide, argon, oxygen or other gases.
...
/**
    ...
    * @param phase - Information about which phase the sample was taken from must be provided.
    * @param biocatalyst_in_phase - Information on whether the collected sample may be contaminated with the (bio)catalyst.
    * @param special_treatment - If there are any other specific methods, procedures, characteristics or aspects related to the sampling that are important for reproducibility and are not described by the aforementioned                     metadata, they should be explained here.
**/
